...
if __name__ == '__main__':
    ...
    #environment for "place bowl" test
    ...
    #hanging rack test
    tri_mesh_env = trimesh.load_mesh('./data/it/hanging-rack.ply', process=False)
    testing_point = [-0.0964215267, 0.000641775, 0.2052559852] #top of hanging rack
    #testing_point  = [-0.48689266781021423, -0.15363679409350514,0.8177121144402457] # in the middle of hanging rack

    analyzer = tester.get_analyzer(tri_mesh_env, testing_point)
