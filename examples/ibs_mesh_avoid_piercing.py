...
if __name__ == '__main__':
    ...
    directory = './output/ibs_mesh_avoid_piercing/'
    ...
    for sampled_points in points:
        ...
        print ("time:", end - start , " original_points: ", sampled_points, " final_env_points: " , size_env_sampled_points, " final_obj_points: ",  size_obj_sampled_points )  
        ...
        with open(directory+"horizontal_orig_sampling_"+str(sampled_points)+"_"+env+"_"+str(size_env_sampled_points)+"_"+obj+"_"+str(size_obj_sampled_points)+".png", 'wb') as f:
                    f.write(png)
                    f.close()
        ...
        png = visualizer2.save_image()
        with open(directory+"diagonal_orig_sampling_"+str(sampled_points)+"_"+env+"_"+str(size_env_sampled_points)+"_"+obj+"_"+str(size_obj_sampled_points)+".png", 'wb') as f:
                    f.write(png)
                    f.close()
