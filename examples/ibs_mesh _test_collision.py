...
if __name__ == '__main__':
    ...
    data_frame=pd.DataFrame(columns=['obj_sample', 'env_sample','resamplings', 'obj_resampling', 'env_resampling', 'exec_time','in_collision'])
    ...
    while in_collision :
        ...
        print("----------------------------------")
        data_frame.loc[len(data_frame)]=[ sampled_points, sampled_points, resamplings, size_obj_sampled_points, size_env_sampled_points, execution_time,in_collision ]
